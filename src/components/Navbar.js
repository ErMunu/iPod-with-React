...
import BatImg from "../assets/images/icons/battery.png"
...
class Navbar extends React.Component {
    ...
    // if there is no notification then iPod logo, time and battery icon else show notification for 1 second
    componentDidMount() {
